...
export const RELEASE_C_FIXTURES: readonly ArticulationFixture[] = [
  ...
  { ...fixture('touch-actuated-lever', 'Touch-actuated lever', 'A real touch transition emits a bounded effort command.', 'effort', 'touch', [{ tick: 10, kind: 'touch-joint-effort', value: 5 }]), expectedTransitions: { enter: 1, stay: 0, leave: 1 } },
